...
// referência do elemento "pássaro"
let bird = document.querySelector('.bird');

//Recolhendo propriedades do elemento "pássaro"
let bird_props = bird.getBoundingClientRect();
let background =
	document.querySelector('.background')
			.getBoundingClientRect();
	
// Referência do elemento "score" (pontuação)
let score_val =
...
// Começar o jogo com a tecla enter
if (e.key == 'Enter' &&
	game_state != 'Play') {
...
function move() {
	...
	// Referência dos elementos dos canos
	...
	if (pipe_sprite_props.right <= 0) {
		...
		// Colisão detectada entre o pássaro e o scanos
		if (
...
function create_pipe() {
	...
	// Se a distância entre dois canos se exceder
	// do valor predefinido
	if (pipe_seperation > 115) {
	pipe_seperation = 0
		
	// Calcular a posição aleatória dos canos em y axis
